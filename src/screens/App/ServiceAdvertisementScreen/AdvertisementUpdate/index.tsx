...
import { updateAdvertisement } from '../../../../api/API/advertisement'

const AdvertisementUpdate: React.FC = ({ navigation, route }) => {
  ...
  useEffect(() => {
    if (route.params?.item) {
      ...
      setAdvertisementContent(advertisementContent)
      setAdverLocation(adverLocation)
      setAdvertisementImage(advertisementImage)
    }
  }, [route.params?.advertisement])
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const response = await updateAdvertisement(
        userData.token,
        route.params.item.advertisementId,
        formData
      )

      if (response) {
        showMessage({
          message: 'Bài quảng cáo đã được cập nhập thành công!',
          type: 'success'
        })
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Cập nhập bài quảng cáo</Text>
      </View>
      ...
      <View style={styles.formContainer}>
        ...
        {advertisementImage && (
          <Image
            source={{ uri: advertisementImage.uri || advertisementImage }}
