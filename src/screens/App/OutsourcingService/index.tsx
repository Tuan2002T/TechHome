...
const AddOutsourcingServiceScreen: React.FC = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      formData.append('file', {
        uri: outsourcingServiceImage.uri,
      ...
      const response = await createOutsourcingService(userData.token, formData)
      if (response) {
        showMessage({
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {outsourcingServiceImage && (
        <Image
          source={{ uri: outsourcingServiceImage.uri }}
...
export default AddOutsourcingServiceScreen
